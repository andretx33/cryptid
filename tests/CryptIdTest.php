...
test('CryptID correctly encrypts and decrypts numeric string IDs', function () {
    $crypt = new CryptId();
...
test('CryptID correctly encrypts and decrypts numeric integer IDs', function () {
    $crypt = new CryptId();
    ...
    expect($decrypted)->toBe((string) $original);
});
...
test('CryptID does not decode empty values', function (mixed $value) {
    $crypt = new CryptId();
